...
React.createElement("svg", { className: "vb", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 530 160.1" }, /*#__PURE__*/
...
class App extends React.Component {
  ...
  render() {
    ...
    return /*#__PURE__*/(
      ...
      React.createElement("div", { className: "er" }, /*#__PURE__*/
      React.createElement("h1", null, "¿Cómo te sientes ahora?"), /*#__PURE__*/
      React.createElement("div", { className: "jkl" }, /*#__PURE__*/
      ...
      React.createElement("div", { className: "ty" }, /*#__PURE__*/
      React.createElement("qw", { onClick: () => this.setAnimation('passive') }, "Pasivo"), /*#__PURE__*/
      React.createElement("qw", { onClick: () => this.setAnimation('waiting') }, "Esperando"), /*#__PURE__*/
      React.createElement("qw", { onClick: () => this.setAnimation('thinking') }, "Pensando"), /*#__PURE__*/
      React.createElement("qw", { onClick: () => this.setAnimation('typing') }, "Tomando notas"), /*#__PURE__*/
      React.createElement("qw", { onClick: () => this.setAnimation('stressed', 240) }, "Estresado")),

      animation === 'stressed' && /*#__PURE__*/
      React.createElement("div", { className: "as" }, /*#__PURE__*/
